...
public:
    ...
    QPushButton *serialport_pushButton;
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(1054, 728);
        QIcon icon;
        ...
        menubar->setGeometry(QRect(0, 0, 1054, 28));
        ...
        dock_status->setMinimumSize(QSize(325, 446));
        ...
        serialport_pushButton = new QPushButton(frame);
        serialport_pushButton->setObjectName(QString::fromUtf8("serialport_pushButton"));

        verticalLayout_3->addWidget(serialport_pushButton);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        serialport_pushButton->setText(QApplication::translate("MainWindowDesign", "SerialPort", 0, QApplication::UnicodeUTF8));
