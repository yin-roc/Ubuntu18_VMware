...
void class1_ros_qt_demo::GpsThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GpsThread *_t = static_cast<GpsThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject class1_ros_qt_demo::GpsThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_class1_ros_qt_demo__GpsThread.data,
      qt_meta_data_class1_ros_qt_demo__GpsThread,  qt_static_metacall, nullptr, nullptr}
};
