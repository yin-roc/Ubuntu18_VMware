...
#include "../../../../src/ros_qt_demo/include/ros_qt_demo/mylabel.h"
...
QT_MOC_LITERAL(1, 8, 13), // "keyNumchanged"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 3) // "num"

    },
    "MyLabel\0keyNumchanged\0\0num"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::keyNumchanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::keyNumchanged(int _t1)
{
